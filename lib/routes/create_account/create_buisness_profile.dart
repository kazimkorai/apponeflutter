...
class CreateBusinessProfile extends StatefulWidget {
  @override
  _CreateBusinessProfileScreenState createState() =>
      _CreateBusinessProfileScreenState();
}
...
class _CreateBusinessProfileScreenState extends State<CreateBusinessProfile> {
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: new MultiSelect(
                            ...
                            hintText: "Please select interests (Min: 2 and Max: 8)",
                            maxLength: 8,
                            // optional
 ...
 /*   if (imageFile == null) {
    ...
    ///Hard Coded for testing.
      ...
      CTheme.showAppAlertOneButton(  "Okay",context: context,title: 'Error',
