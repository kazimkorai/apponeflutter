        ...
        body: BaseScrollView().baseView(context, [
          ...
          Padding(
            ...
            child: roundedSquareButton(
                Localization.stLocalized('createSocialProfile'), 50, () async {
              if (validateFields()) {
                userSociaData = {
  ...
  Future addValueToSharedPreference(CreateUserViewModel model) async {
    await SharedPreferences.getInstance().then((value) => {
          ...
          value.setString(Globals.profileStatus,
              model.registrationData.data.profileStatus.toString()),
    value.setString(Globals.socialProfileId, model.registrationData.data.userProfileId.toString()),
          value.setBool("isHasSocialAccount", true),
      value.setString(Globals.urlImageSocial,  model.registrationData.data.profileImage.toString()),
