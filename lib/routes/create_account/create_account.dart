  ...
  void termsConditionsCb(bool value) {
    if (isTermConditionsChecked == false) {
      ...
      CTheme.showAppAlertOneButton(
          ...
          bodyText: "I accept the terms & agreements",
   );
    } else {
 ...
 /*       'latitude':33.6844,
  ...
  registerUserInApi(CreateUserViewModel model) async {
    ...
    if (model.registerSuccess) {
      ...
      CTheme.showAppAlertOneButton(
          ...
          bodyText: "Please complete your Social Profile.",
  ...
  Future addValueToSharedPreference(CreateUserViewModel model) async {
    await SharedPreferences.getInstance().then((value) => {
          ...
          value.setString(Globals.countryId, model.registrationData.data.userCountryId.toString()),
          value.setString(Globals.cityId, model.registrationData.data.userCityId.toString()),
      value.setString(Globals.countryName, model.registrationData.data.userCountryName.toString()),
      value.setString(Globals.cityName, model.registrationData.data.userCityName.toString()),
value.setString(Globals.dateOfBirth,model.registrationData.data.dateOfBirth),

    Globals.serverToken=model.registrationData.data.token
    });
  }
